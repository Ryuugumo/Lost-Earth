...
public class ItemToolLE extends Item
{
    ...
    protected EnumToolMaterialLE toolMaterial;

    protected ItemToolLE(int par1, int par2, EnumToolMaterialLE par3EnumToolMaterial, Block[] par4ArrayOfBlock)
    {
        super(par1);
